# -*- coding: utf-8 -*-
"""feat_match_ensemble_lg.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1k5jxujlCCdOzCNe-BeM8_AWgu6_H_Di9
"""
...
def product_on_bottle_lg(image_name):
    ...
    ## patch1 not working for 1,2,5,6,
    ...
    match_thresh = {'cv2.TM_CCOEFF_NORMED':0.81}  ## ---> old 
    # match_thresh = {'cv2.TM_CCOEFF':3800000}

    # methods = ['cv2.TM_CCOEFF', 'cv2.TM_CCOEFF_NORMED', 'cv2.TM_CCORR','cv2.TM_CCORR_NORMED', 'cv2.TM_SQDIFF', 'cv2.TM_SQDIFF_NORMED']
    methods = ['cv2.TM_CCOEFF_NORMED']
    patches = ['fyp_project/defect_algos/patch5.jpg','fyp_project/defect_algos/patch8.jpg','fyp_project/defect_algos/patch10.jpg','fyp_project/defect_algos/patch12.jpg','fyp_project/defect_algos/patch14.jpg',]
    ...
    for meth in methods:
        ...
        #     check to ignore cocked cap area
            ...
            if (top_left[0] <= 250 and top_left[1] >= 550) or (top_left[0] >= 600 and top_left[1] >= 250)  :
                ...
                if max_val > match_thresh['cv2.TM_CCOEFF_NORMED']:
