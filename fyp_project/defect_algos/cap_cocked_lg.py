...
Original file is located at
    https://colab.research.google.com/drive/103oWfIqq2HoZhpMLD2WBjnhd2Xv3w46k
"""
...
def cap_cocked_lg(path):
    ...
    #         print(rho)
    #         print(theta)
            if  rho > 600 and rho < 800 and theta  >1 :
                theta = lines[i][0][1]
                thetas.append(theta)
